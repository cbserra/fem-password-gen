...
const GeneratedPassword: FC<GeneratedPasswordProps> = (params: { passwordResult: PasswordResult}) => {
  const { passwordResult } = params
  
  return (
    <div className={twclsx("password__gen-input section text-heading-md p-[1.6rem] justify-between")}>
      <input 
        type="text" 
